                    ...
                    buttons: [
                        {
                            ...
                            handler: function () {
                                ...
                                CS('CZCLZ.Model.AddModel2', function (retVal) {
                                    if (retVal) {
                                        DataBind(1);
                    ...
                    buttons: [
                        {
                            ...
                            handler: function () {
                                ...
                                CS('CZCLZ.Model.XGModel2', function (retVal) {
                                    if (retVal) {
...
function CheckWLData(mid, SearchCompany) {
    CS('CZCLZ.Model.SelectWL2', function (retVal) {
        if (retVal) {
...
function CheckWL(mid, Company, UserName) {
    CS('CZCLZ.Model.CheckWL2', function (retVal) {
        if (retVal) {
...
function WLBind(mid) {
    CS('CZCLZ.Model.WLBind2', function (retVal) {
        if (retVal) {
...
function DelYGLWL(MX_ID, mid) {
    Ext.Msg.confirm("提示", "是否删除？", function (btn) {
        if (btn == "yes") {
            CS('CZCLZ.Model.DeleteYGLWL2', function (retVal) {
                if (retVal) {
                    WLBind(mid);
                }
            }, CS.onError, MX_ID);
...
function DataBind(cp) {
    CS('CZCLZ.Model.GetModelList2', function (retVal) {
        if (retVal) {
            MbStore.setData({
                data: retVal.dt,
                pageSize: pageSize,
...
function Xg(mid) {
    CS('CZCLZ.Model.GetModelDetail2', function (retVal) {
        if (retVal) {
...
function HQ(mid) {
    var win = new URLWin();
    win.show(null, function () {
        Ext.getCmp("Url").setText("http://templet.chahuobao.net/MbView/ViewTwo.aspx?id=" + mid);
    });
}
...
function Del(id) {
    Ext.Msg.confirm("提示", "是否删除？", function (btn) {
        if (btn == "yes") {
            CS('CZCLZ.Model.DeleteModel2', function (retVal) {
                if (retVal) {
